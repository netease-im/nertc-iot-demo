...
#define USER_SUPPORT_PROFILE_BIP    0
...
#if (RCSP_ADV_EN || (RCSP_MODE || SMART_BOX_EN))
...
#define DEF_BLE_DEMO_NET_CFG_QYAI         15
//luy
#define DEF_BLE_DEMO_NET_CFG_COZE         16
...
#elif BT_NET_CFG_GIZWITS_EN
#define TCFG_BLE_DEMO_SELECT          DEF_BLE_DEMO_NET_CFG_COZE
...
#elif BT_NET_CFG_QYAI_EN
#define TCFG_BLE_DEMO_SELECT          DEF_BLE_DEMO_NET_CFG_QYAI
